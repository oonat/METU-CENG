...
void WriteOutput(SenderInfo* senderInfo, ReceiverInfo* receiverInfo, DroneInfo* droneInfo, HubInfo* hubInfo, Action action) {
    ...
    switch (action) {
        case SENDER_CREATED:
            ...
            printf("AID: SENDER_CREATED SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("CHID: %d RPC: %d\n", senderInfo->current_hub_id, senderInfo->remaining_package_count);
            break;
        case SENDER_STOPPED:
            ...
            printf("AID: SENDER_STOPPED SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("CHID: %d RPC: %d\n", senderInfo->current_hub_id, senderInfo->remaining_package_count);
            break;
        case SENDER_DEPOSITED:
            ...
            printf("AID: SENDER_DEPOS SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("CHID: %d RPC: %d PRID: %d PRHID: %d\n", senderInfo->current_hub_id,
                    senderInfo->remaining_package_count, senderInfo->packageInfo->receiver_id,
                    senderInfo->packageInfo->receiving_hub_id);
        ...
        case RECEIVER_CREATED:
            ...
            printf("AID: RECEIVER_CREATED SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("CHID: %d\n", receiverInfo->current_hub_id);
            break;
        case RECEIVER_STOPPED:
            ...
            printf("AID: RECEIVER_STOPPED SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("CHID: %d\n", receiverInfo->current_hub_id);
            break;
        case RECEIVER_PICKUP:
            ...
            printf("AID: RECEIVER_PICKUP SID: %d RID: %d DID: %d HID: %d time stamp: %llu ", senderID, receiverID,
            droneID, hubID, time);
            printf("CHID: %d PSID: %d PSHID: %d\n", receiverInfo->current_hub_id,
                    receiverInfo->packageInfo->sender_id, receiverInfo->packageInfo->sending_hub_id);
            break;
        case DRONE_CREATED:
            ...
            printf("AID: DRONE_CREATED SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("CHID: %d CR: %d\n", droneInfo->current_hub_id, droneInfo->current_range);
            break;
        case DRONE_STOPPED:
            ...
            printf("AID: DRONE_STOPPED SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("CHID: %d CR: %d\n", droneInfo->current_hub_id, droneInfo->current_range);
            break;
        case DRONE_PICKUP:
            ...
            printf("AID: DRONE_PICKUP SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("CHID: %d CR: %d PSID: %d PSHID: %d\n", droneInfo->current_hub_id, droneInfo->current_range,
                    droneInfo->packageInfo->sender_id, droneInfo->packageInfo->sending_hub_id);
            break;
        case DRONE_DEPOSITED:
            ...
            printf("AID: DRONE_DEPOSITED SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("CHID: %d CR: %d PRID: %d PRHID: %d\n", droneInfo->current_hub_id, droneInfo->current_range,
                   droneInfo->packageInfo->receiver_id, droneInfo->packageInfo->receiving_hub_id);
            break;
        case DRONE_GOING:
            ...
            printf("AID: DRONE_GOING SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("CHID: %d CR: %d NHID: %d\n", droneInfo->current_hub_id, droneInfo->current_range,
                    droneInfo->next_hub_id);
            break;
        case DRONE_ARRIVED:
            ...
            printf("AID: DRONE_ARRIVED SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("CHID: %d CR: %d\n", droneInfo->current_hub_id, droneInfo->current_range);
            break;
        case HUB_CREATED:
            ...
            printf("AID: HUB_CREATED SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("\n");
            break;
        case HUB_STOPPED:
            ...
            printf("AID: HUB_STOPPED SID: %d RID: %d DID: %d HID: %d time stamp: %llu ",  senderID, receiverID,
            droneID, hubID, time);
            printf("\n");
            break;
        default:
